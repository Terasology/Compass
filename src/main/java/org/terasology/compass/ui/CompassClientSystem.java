...
public class CompassClientSystem extends BaseComponentSystem {
    /**
     * The logger for debugging to the log files.
     */
    private static final Logger logger = LoggerFactory.getLogger(CompassClientSystem.class);
    ...
    public void preBegin() {
        nuiManager.getHUD().addHUDElement("Compass:Compass");
    }
